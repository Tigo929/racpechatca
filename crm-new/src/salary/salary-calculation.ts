 ...
 *
 * Внешние продукты печатает партнёр-подрядчик: футболки через PARTNER_REWARD,
 * холсты через расход CANVAS_CONTRACTOR. Начислить сверху процент своему
 * сотруднику — заплатить за одну работу дважды, поэтому зарплата начисляется
 * только по фотопечати.
 *
