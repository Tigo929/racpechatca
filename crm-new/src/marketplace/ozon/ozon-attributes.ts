...
/**
 * Рисунок/тематика (атрибут 9437) заполняется свободным текстом — Ozon
 * принимает его без dictionary_value_id, поэтому не нужен отдельный поиск
 * по словарю на каждое сохранение принта.
 */
