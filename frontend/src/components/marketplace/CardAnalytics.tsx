...
export function CardAnalytics({
  ...
  /*
   * Ozon ограничивает частоту обращений к аналитике: в логах уже были 429
   * вместо цифр. Поэтому ответы держим час — спрос за прошедшие дни не
   * меняется каждую минуту, и повторный запрос при каждом открытии карточки
   * стоит дороже свежести. Повтор при ошибке один, а не по умолчанию три:
   * упереться в лимит и тут же долбить его снова — худшее, что можно
   * сделать.
   */
