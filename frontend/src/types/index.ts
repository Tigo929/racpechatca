...
export interface OrderPhoto {
  ...
  urgencyFee?: number;
  /**
   * Скидка клиенту в рублях. Уменьшает чек и базу зарплаты исполнителя:
   * скидку делим с ним. Больше товара с дизайном сервер не примет —
   * доставку и срочность скидка не трогает.
   */
