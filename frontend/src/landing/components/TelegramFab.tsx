...
export function TelegramFab() {
  return (
    <a
      ...
      className="fab fixed bottom-5 right-5 z-40 w-14 h-14 rounded-full bg-[#229ED9] hover:bg-[#1b8ec2] flex items-center justify-center shadow-2xl shadow-sky-900/30"
    >
