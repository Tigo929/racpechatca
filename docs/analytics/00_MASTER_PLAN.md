...
```text
PLANNED (23.09.2026) — предложен Reviewer после приёмки этапа 15. ТЗ не выдано,
работа не начиналась. Production baseline: 9ccd29351a728c7e43f58c1ad7b7bba894e6e6af.
```
...
Открытые вопросы к ТЗ: где хранить готовые файлы и как долго; кто имеет право генерировать
(ADMIN или шире); нужен ли автоматический график; допустимо ли класть PDF-движок в образ.
