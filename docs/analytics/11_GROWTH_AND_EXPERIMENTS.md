...
`DONE` (Reviewer, 16.09.2026: «11_GROWTH_AND_EXPERIMENTS = DONE»; production master 5922175). Реализовано 15.09.2026 в `feature/analytics-foundation` (с влитым master 3ac9be8): реестр изменений и
