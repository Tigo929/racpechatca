...
Live smoke выполнен 11.09.2026 настоящим токеном: counter 200, 13 целей,
Reports API за 7 дней получен, `GOALS_MANIFEST.md` сверён — отчёт в
`05_YANDEX_METRIKA_API.md`, раздел 34. Токен на сервере пока отсутствует
(использован разово из окружения процесса и подлежит перевыпуску).

Причина исходной блокировки (снята):
