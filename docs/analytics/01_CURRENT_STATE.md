...
Все пять уходят с заявкой в `apps/api`, оттуда — в CRM.
...
| 2 | UTM пишутся только у футболок и только три из пяти | `buildTshirtNote`, ~2056 | у фото и холста источник неизвестен; `utm_content`, `utm_term` теряются везде |
