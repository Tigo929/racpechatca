...
| Факт | Подробности |
|---|---|
| Статус | Reviewer 14.09.2026: `00–08 = DONE`, `09 = READY_FOR_PRODUCTION_ROLLOUT`; rollout выполнен 14.09 18:44–20:17 MSK по команде «СТАРТ» строго по `09_PRODUCTION_ROLLOUT.md` — отчёт § 18; ждёт owner smoke § 11 и verdict Reviewer |
